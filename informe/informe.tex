...
\begin{document}
    ...
    De la misma forma, si se considera necesario, el Gerente puede dar de baja un proveedor. No va a poder ser referenciado en ningún nuevo pedido o compra, pero los registros que lo mencionen quedarán intactos y se podrán consultar sin ningún problema.
    ...
    Si un artículo recibido ya forma parte de la lista de productos, se actualiza el stock con la nueva cantidad. En caso de tratarse de un artículo que se adquiere por primera vez, el Gerente lo agrega a la lista de productos con la información pertinente y la cantidad que ingresó. 
    ...
    Puede suceder que un producto del itinerario se encuentre roto o en mal estado, por lo tanto el Gerente debe actualizar el stock de forma manual para reflejar estos cambios.

    Una gran mayoría de los artículos tienen sus precios dolarizados, por lo tanto la lista de precios se mantiene actualizada en base a la valuación del dólar. Con respecto a los artículos con precios no dolarizados, el Gerente realiza una actualización mensual de sus precios.
   ...
   El técnico abre una \OT{} y se asigna a sí mismo como el que atendió la solicitud y como encargado de la \OT{} creada (de cualquier manera, el Jefe de Taller puede cambiar el encargado mientras no se comience a trabajar en la misma). La \OT{} se encuentra en estado \textit{Asignada} \footnote{Para ver los distintos estados de una \OT{}, ver Anexo 2}. 
    ...
    \begin{enumerate}	
        ...
        \subsubsection*{Equipos}
            ...
            %\item Registrar salida de Equipo
                %tiene que verificar que el equipo esté en el taller (jeje)
                %y que la OT en la que aparezca esté cerrada (pendiente de facturación)
            %\item Agregar Equipo
        ...
        \subsubsection*{Productos}
            ...
            %\item Modificar Proveedor de un producto - Llega mal es de menos o no llega
        ...
        \subsubsection*{Órdenes de trabajo}
            ...
            %una tarea (la tarea a su vez va a hacer referencia a un Tipo servicio y un tipo de equipo; ya tiene su tarifa),
            %y posibles repuestos

            %las Tipo tarea que se van a poder agregar a una OT, van a ser las del tipo de equipo correspondiente al
            ...
            %de equipo son los que tienen las Tipo tarea. Así que, bueno, al momento de vincular una tarea
