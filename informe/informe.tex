...
\begin{document}
   ...
   %quién puede abrir OT??????????? 
    ...
    \begin{itemize}
        \item El cliente se acerca a la oficina de la organización a retirar el equipo. Se confecciona la factura (ver sección TAL) y la \textit{Orden de Trabajo} se cambia al estado \textit{Entregada}.
