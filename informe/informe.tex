...
\begin{document}
    ...
    Otra posible situación es que el pedido que llegó concuerda con lo solicitado pero llegan artículos defectuosos o en mal estado. El Operario Contable se comunica con el proveedor y acuerdan enviar de vuelta al proveedor el o los defectuosos (el proveedor cubre el envío). Como en el caso anterior, se registra un nuevo pedido y el anterior se marca como ``pendiente''.
   ...
   El técnico abre una \OT{} y se asigna a sí mismo como el que atendió la solicitud y como encargado de la \OT{} creada (de cualquier manera, el Jefe de Taller puede cambiar el encargado mientras no se comience a trabajar en la misma). La \OT{} pasa a estado \textit{Asignada} \footnote{Para ver los distintos estados de una \OT{}, ver Anexo 2}. 
    ...
    Cuando un técnico revisa el equipo de una \OT{}, lista las tareas y subtareas que cree necesarias para realizar la reparación y también los repuestos que se requerirán para completar el trabajo. En este momento, la \OT{} se encuentra en estado \textit{Revisada}. 
    ...
    Realizada esta revisión, se confecciona un presupuesto sumando los valores de las tareas y subtareas a realizar y los valores de los posibles repuestos a utilizar. En caso de que se esté trabajando con un tipo de equipo que no esté presente en el tarifario, el Jefe de Taller decide el precio a cotizar por el equipo. La \OT{} se pasa a estado \textit{Cotizada}.
    ...
    %Falta incorporar cómo se cotizan y facturan las horas técnico, los traslados para las visitas
