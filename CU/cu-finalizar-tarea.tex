...
%/******************************************************/
	...
	\begin{longtable}{ |p{8cm}|p{8cm}| }
		...
		\hline
            ...
            \hline
            & \inc Marca la tarea como finalizada, registrando su fecha y hora de finalización, y agregando la observación realizada, y .\\
            \hline
            \inc Fin CU. & \\
        \hline
		...
		\hline	
        \multicolumn{2}{|p{16cm}|}{\textbf{7c. }El Sistema informa que la cantidad de repuesto ingresada excede la cantidad reservada. Ir al paso 12}\\
		\hline	
