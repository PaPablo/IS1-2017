...
%/******************************************************/
	...
	\begin{longtable}{ |p{8cm}|p{8cm}| }
		...
		\multicolumn{2}{|p{16cm}|}{\textbf{Postcondiciones}: Tarea marcada finalizada}\\
		\hline
		...
		\hline
            ...
            \hline
            & \inc Muestra el los repuestos asignados a la Tarea.\\
            \hline
            \inc Repetir pasos x al x mientras el Técnico desee registrar la utilización de respuestos asociados a la Tarea& \\
            \hline
            ...
            \hline
            & \inc Marca la tarea como finalizada, registrando su fecha y hora de comienzo, y agregando la observación realizada.\\
            \hline
            & \inc Muestra los datos de la tarea finalizada.\\
            \hline
            \inc Fin CU. & \\
        \hline
		...
		\hline	
        \multicolumn{2}{|p{16cm}|}{\textbf{7b. }El Sistema informa que la Tarea no pela Tarea no existe. Ir al paso 12}\\
		\hline	
